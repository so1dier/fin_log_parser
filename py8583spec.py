...
class IsoSpec1987_idebitc(IsoSpec1987):
    def SetDataTypes(self):
        self.ContentTypes = ContentTypes['idebitc']
        self.DataType('MTI', DT.BCD)
        self.DataType(1, DT.BIN) # bitmap
        self.IgnoreFields = IgnoreFields_idebitc
...
ContentTypes['1987'] = {
    ...
    #28 :  { 'ContentType':'z',    'MaxLen': 9,   'LenType': LT.FIXED },
    ...
    #102 : { 'ContentType' : 'ans', 'MaxLen' : 4, 'LenType': LT.FIXED },
    103 : { 'ContentType' : 'ans', 'MaxLen' : 28, 'LenType': LT.LLVAR },
    #103 : { 'ContentType' : 'ans', 'MaxLen' : 4, 'LenType': LT.FIXED },
